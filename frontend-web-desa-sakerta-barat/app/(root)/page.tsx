    ...
    <div className='h-full w-full flex-col'>
      ...
      <div className="headline flex px-10 gap-3 h-4/6 relative">
        <div className="text-headline lg:flex-1 md:flex-1 z-[100]">
          <div className="flex items-center h-full">
            ...
            <p className='pt-2 text-sm text-green-200'>Melampaui Batas: Desa Sakerta Barat Membawa Inovasi dan Transformasi untuk Masa Depan yang Cerah</p>
            </div>
          </div>
      ...
      <div className="flex w-full p-10 justify-between ">
        ...
        <div className="sambutan w-full h-full flex-auto">
          <h2 className='title-sambutan lg:h3-medium sm:p-medium-24 text-green-600'>Sambutan Kepala Desa</h2>
          <p className='p-semibold-14 lg:p-bold-16'>Nama Lengkap</p>
          <p className='p-medium-12 lg:p-medium-16'>Jabatan</p>
          <p className='my-2 p-regular-12 lg:p-regular-14'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam nesciunt veritatis quo saepe, sed aperiam numquam illo voluptatibus aut ea.</p>
        </div>
      </div>
